...
<center>![***Fig. 1.*** Bellabeat Leaf's.](bellabeat.jpeg){width=auto}</center>
...
![***Fig. 4.*** Very Active Minutes by Day of the Week.](veryactiveminutesbydayoftheweek.png)
...
![***Fig. 5.*** Sedentary Minutes by Day of the Week](sedentaryminutesbydayoftheweek.png)
...
![***Fig. 6.*** Total Steps by Day of the Week](totalstepsbydayoftheweek.png)
...
![***Fig. 7.*** Relationship between Total Steps and Calories](relationshipbetweentotalstepsandcalories.png)
...
![***Fig. 8.*** Total Distance During Each day](totaldistanceduringeachday.png)
...
![***Fig. 9.*** Total Distance by Month](totaldistancebymonth.png)
...
![***Fig. 10.*** Total Steps and Total Distance by Day of Week](totalstepsandtotaldistancebydayofweek.png)
...
![***Fig. 11.*** Total Steps and Total Distance by Month](totalstepsanddistancebymonth.png)
...
![***Fig. 12.*** Average Activity Minutes by Day of Week](averageactivityminutesbydayofweek.png)
...
![***Fig. 13.*** Total Calories During Each Day](totalcaloriesduringeachday.png)
...
![***Fig. 14.*** Total Calories by Month](totalcaloriesbymonth.png)
...
![***Fig. 15.*** Total Minutes A Sleep During Each Day](totalminutessleepduringeachday.png)
...
![***Fig. 16.*** Total Minutes A Sleep by Month](totalminutesasleepbymonth.png)
...
![***Fig. 17.*** Total WeightKg During Each Day](totalweightKgduringday.png)
...
![***Fig. 18.*** Weight Distributions (Kg)](weightdistributions.png)
...
![***Fig. 19.*** Weight (Pounds) by Report Type](weightbyreporttype.png)
